...
<TextInput className='flex-1 ml-2 text-primary px-4 py-3 ' placeholder='Serch products...' 
returnKeyType='search' placeholderTextColor={COLORS.secondary}/>
</View>
{/* filter icon */}
<TouchableOpacity className='bg-gray-800 w-12 u-12 items-center justify-center rounded-xl'>
...
numColumns={2}  
contentContainerStyle={{padding:16, paddingBottom: 100}} columnWrapperStyle={{justifyContent: 'space-between'}} renderItem={({item})=>(
 ...
 ListEmptyComponent={
  !loading &&(
    <View className='flex-1 items-center justify-center py-20'>
      <Text className='text-secondary'>No</Text>

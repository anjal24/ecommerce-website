...
<Text className='text-secondary text-base'>Log in to view your profile, orders, and addresses.</Text>
<TouchableOpacity  
...
className='bg-primary w-3/5 py-3 rounded-full items-center shadow-lg'>
  <Text>Login /Sign Up</Text>
          ...
          {/*Admin panel Botton if user is admin  */}
...
<View className='w-10 h-10 bg-surface rounded-full items-center  justify-centermr-4'>
  <Ionicons name = {item.icon as any} size={20} color ={COLORS.primary}/>
</View>
<Text className='flex-1text-primary font-medium'>{item.title}</Text>

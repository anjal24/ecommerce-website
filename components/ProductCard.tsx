...
const {toggleWishlist, isInWishlist} = useWishlist()
 const isLiked=  isInWishlist(product._id)   //variable
  return (
...
{/* is Featured */}
{product.isFeatured &&(
  <View className='absolute top-2 left-2 bg-black px-2 rounded'>
...
<View className='flex-row items-center'>
  <Text className='text-primary font-bold text-base'>${product.price.toFixed(2)}
